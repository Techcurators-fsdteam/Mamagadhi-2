        ...
        <div className="relative bg-gradient-to-br from-[#4AAAFF] to-white rounded-2xl shadow-2xl max-w-md w-full p-8 mx-4" style={{ backdropFilter: 'blur(16px)' }}>
          ...
          <div className="flex bg-white/20 rounded-lg p-1 mb-6">
            ...
            <button
              ...
              className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${authMethod === 'phone'
                  ? 'bg-white text-[#4AAAFF] shadow-sm'
                  : 'text-black/50 hover:bg-white/10'
                }`}
            >
            ...
            <form onSubmit={handleEmailLogin} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  ...
                  />
                  <span className="ml-2 text-sm text-black/50">Remember me</span>
                </label>
                <button
                  type="button"
                  ...
                  <div>
                    ...
                    <div className="flex">
                      ...
                      <input
                        ...
                        required
                        className="flex-1 px-4 py-3 bg-white border border-gray-300 rounded-r-lg focus:ring-2 focus:ring-[#35a4c9] focus:border-transparent outline-none transition-all text-gray-800 placeholder-gray-500"
