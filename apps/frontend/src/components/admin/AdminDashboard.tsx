      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <div className="space-y-3">
            <button
              onClick={loadData}
              className="w-full px-4 py-2 bg-[#4AAAFF] text-white rounded-lg hover:bg-[#3A9AEF] focus:outline-none focus:ring-2 focus:ring-[#4AAAFF]"
            >
              Try Again
            </button>
            <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center py-4 sm:py-6 gap-4">
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              <button
                onClick={loadData}
                className="px-3 py-2 sm:px-4 sm:py-2 bg-[#4AAAFF] text-white rounded-lg hover:bg-[#3A9AEF] focus:outline-none focus:ring-2 focus:ring-[#4AAAFF] transition-colors text-sm sm:text-base"
              >
                Refresh All
              </button>
              <button
                onClick={onSignOut}
                className="px-3 py-2 sm:px-4 sm:py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 transition-colors text-sm sm:text-base"
              >
                Sign Out
              </button>
            </div>
